                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Witam w Sekcji Komentarze przepisu
...
<div class="table-responsive"> 
 <table class="table table-bordered table-hover">
    ...
    <?php
        ...
        $query = "SELECT * FROM comments WHERE comment_recipe_id =" . mysqli_real_escape_string($connection, $_GET['id']);
        ...
        while($row = mysqli_fetch_assoc($select_comments)){
            ...
            echo "<td><a href='recipe_comments.php?approve=$comment_id&id=" . $_GET['id'] ."'>Zatwierdz</a></td>";
            echo "<td><a href='recipe_comments.php?unapprove=$comment_id&id=" . $_GET['id'] ."'>Nie zatwierdzaj</a></td>";
            echo "<td><a href='recipe_comments.php?delete=$comment_id&id=" . $_GET['id'] ."'>Usuń</a></td>";
...
if(isset($_GET['approve'])){
    ...
    header("Location: recipe_comments.php?id=" . $_GET['id'] ."");
