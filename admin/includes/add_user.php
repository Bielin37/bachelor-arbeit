<?php
    ...
    if(isset($_POST['create_user'])) {
        ...
        echo "Uzytkownik zostal utworzony: " . " " . "<a href='users.php'>Pokaz Uzytkownikow</a>";
...
?>
    ...
    <div class="form-group">
        <input class="btn btn-primary" type="submit" name="create_user" value="Utworz uzytkownika">
    </div>
